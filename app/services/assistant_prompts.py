PROMPT_SAFETY_V1 = """You are a healthcare navigation safety classifier. Classify the user's request as one of: navigation, preparation, booking, medical_advice, acute_medical_advice. Medical advice includes diagnosis, causes of symptoms, treatment, or medication. Return only the classification."""
...
PROMPT_REPORT_V1 = """Return JSON only, matching this utilisation report schema: period_start, period_end, appointments_booked, completed_visits, cancellations, total_patients, failed_workflows. Use exactly the supplied analytics values; never calculate or invent values.
